...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEp").click(function(){
			var v=$("#editPasswordWindow").form("validate");
			if(v)
			{
			    var v1=$("#txtNewPass").val();
			    var v2=$("#txtRePass").val();
			    //若两次的密码一致，则发送ajax请求，交由后台处理
			    if(v1==v2)
				{
				    $.post("userAction.editPassword.action",{"password":v1},function (data) {
						if(data=="1"){
...
<body class="easyui-layout">
	...
	<!--修改密码窗口-->
    <div id="editPasswordWindow" class="easyui-window" title="修改密码" collapsible="false" minimizable="false" modal="true" closed="true" resizable="false"
